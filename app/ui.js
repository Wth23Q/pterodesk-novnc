...
const UI = {
    ...
    updateLanguage() {
        const language = UI.getSetting('language');
...
* ------v------*/
    ...
    addSettingsHandlers() {
        ...
        UI.addSettingChangeHandler('language', UI.updateLanguage);
        UI.addSettingChangeHandler('language');
...
// Set up translations
const LINGUAS = ["cs", "de", "el", "es", "fr", "it", "ja", "ko", "nl", "pl", "pt_BR", "ru", "sv", "tr", "vi", "zh_CN", "zh_TW"]; // All available languages
